  ...
  const handleResetPasswordSubmit = async (e) => {
    ...
    if (!oldPassword || !newPassword) {
      Swal.fire({
        icon: "error",
        title: "Gagal",
        text: "Password lama dan baru tidak boleh kosong.",
      });
      return;
    }
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "Berhasil!",
        text: `Password untuk ${selectedSales.name} telah diubah.`,
        timer: 2500,
      });
    } catch (error) {
      Swal.fire({
        icon: "error",
        title: "Gagal",
        text: error.response?.data?.msg || "Gagal mereset password.",
      });
    }
  };
    ...
    <DashboardLayout>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
        ...
        <div className="w-full sm:w-auto flex gap-2">
          ...
          <button
            className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 flex-shrink-0"
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredSales.map((sales) => (
            <div
              key={sales.id}
              className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow flex flex-col"
            >
              <div className="p-6 flex-grow">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      onClick={() => handleOpenResetPasswordModal(sales)}
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <div className="border-t my-2 pt-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span>Bergabung: {formatDate(sales.created_at)}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Clock size={14} />
                      <span>
                        Aktif Terakhir: {formatDate(sales.terakhir_aktif)}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="border-t border-gray-100 p-4">
                <Link
                  ...
                  className="w-full bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 text-sm font-semibold transition-colors"
                >
                  Lacak Aktivitas
                </Link>
              </div>
            ...
            {modalMode === "add" && (
              <>
                ...
                <form onSubmit={handleAddSalesSubmit} className="space-y-4">
                  <div>
                    ...
                    <div className="relative mt-1">
                      ...
                      <input
                        ...
                        placeholder="Contoh: jefri teguh"
                        value={newSales.name}
                        onChange={(e) =>
                          setNewSales({ ...newSales, name: e.target.value })
                        }
                        required
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative mt-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNewSales({ ...newSales, username: e.target.value })
                        }
                        required
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative mt-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNewSales({ ...newSales, telpon: e.target.value })
                        }
                      />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="relative mt-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNewSales({ ...newSales, lokasi: e.target.value })
                        }
                      />
                    </div>
                  </div>
                  <button
                    type="submit"
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2.5 rounded-lg font-semibold transition-colors mt-6"
                  >
                    Simpan
                  </button>
                </form>
            ...
            {modalMode === "resetPassword" && selectedSales && (
              <>
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-500">
                    Ubah password untuk{" "}
                    <span className="font-semibold">{selectedSales.name}</span>
                  </p>
                </div>
                <form
